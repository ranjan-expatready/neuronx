...
from mcp.context7_provider import Context7MCPProvider
from mcp.filesystem_provider import FilesystemMCPProvider
from mcp.linear_provider import LinearMCPProvider
from mcp.postgres_provider import PostgresMCPProvider
from mcp.sentry_provider import SentryMCPProvider
from mcp.docker_provider import DockerMCPProvider
from mcp.playwright_provider import PlaywrightMCPProvider
...
class MCPBridge:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.provider_registry = {
            ...
            'linear': LinearMCPProvider,
            'postgres': PostgresMCPProvider,
            'sentry': SentryMCPProvider,
            'docker': DockerMCPProvider,
            'playwright': PlaywrightMCPProvider,
        }
        ...
        self.provider_actions = {
            ...
            'linear': [
                'list_issues', 'get_issue', 'create_issue', 'update_issue', 'search_issues', 'get_user', 'list_comments', 'create_comment'
            ],
            'postgres': [
                'query', 'get_schema', 'describe_table', 'list_tables'
            ],
            'sentry': [
    ...
    def _check_role(self, provider: str, action: str, role: str) -> bool:
        ...
        provider_role_rules = {
            ...
            'context7': ['PLANNER', 'IMPLEMENTER', 'AUDITOR'],  # All roles (read-only)
            'filesystem': ['PLANNER', 'IMPLEMENTER', 'AUDITOR'],
            'linear': ['PLANNER', 'IMPLEMENTER', 'AUDITOR'],
            'postgres': ['IMPLEMENTER', 'AUDITOR'],
            'sentry': ['PLANNER', 'AUDITOR'],
